...
#define sa_def_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
void zsa_w_def(halfword p, integer w);
#define sa_w_def(p, w) zsa_w_def((halfword) (p), (integer) (w))
#define sa_w_def_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
void zgsa_def(halfword p, halfword e);
#define gsa_def(p, e) zgsa_def((halfword) (p), (halfword) (e))
#define gsa_def_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
void zgsa_w_def(halfword p, integer w);
#define gsa_w_def(p, w) zgsa_w_def((halfword) (p), (integer) (w))
#define gsa_w_def_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
void sa_restore(void);
#define sa_restore_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
void znew_save_level(group_code c);
#define new_save_level(c) znew_save_level((group_code) (c))
#define new_save_level_regmem register memory_word *eqtb=zeqtb;
...
#define store_fmt_file_regmem register memory_word *mem=zmem, *eqtb=zeqtb;
...
#define append_src_special_regmem register memory_word *mem=zmem;
...
void main_body(void);
#define main_body_regmem register memory_word *eqtb=zeqtb;
