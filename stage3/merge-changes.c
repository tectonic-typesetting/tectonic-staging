...
void mainbody(void)
{
    boolean patched_preamble = false;
    ...
    /* Disclaim. */
    printf(
        "%% This file is generated by the `tectonic-staging` tools of the Tectonic Project.\n"
        "%% It is not the TeX program, or e-TeX, or TeX-XeT, or XeTeX, although it is\n"
        "%% derived from those works. Any product derived from this file should credit\n"
        "%% those sources while making explicitly clear that it represents a separate entity.\n"
        "%% See below for additional disclaimers, restrictions, and commentary.\n\n"
    );
    ...
    while (!inputhasended) {
        ...
        if (!patched_preamble && strncmp(buffer, "This is \\XeTeX", 14) == 0) {
            printf(
                "This document was generated as part of the Tectonic Project.\n"
