    ...
    while (fgets(buf, BUFSIZ, stdin)) {
        ...
        while (*cp != ')') {
            if (*cp == '\'' || strncmp(cp, "xchr", 4) == 0
                || (strncmp(cp, "HEX", 3) == 0 && (STREQ(program_name, "ofm2opl")
                ...
                || (strncmp(cp, "buffer", 6) == 0 && (STREQ(program_name, "vptovf")
                                                      ...
                                                      || STREQ(program_name, "opl2ofm")))
                || (((strncmp(cp, "buf", 3) == 0
                      || strncmp(cp, "xdig", 4) == 0 || strncmp(cp, "xext", 4) == 0 || strncmp(cp, "xhyf", 4) == 0)
            ...
            else if (strncmp(cp, "stringcast", 10) == 0 || strncmp(cp, "conststringcast", 15) == 0) {
                *as++ = '%';
                *as++ = 's';
